        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4">
              <Link href="https://instagram.com" className="text-gray-600 dark:text-gray-300 hover:text-[#007BFF] dark:hover:text-[#007BFF] transition-colors">
              ...
              <Link href="https://whatsapp.com" className="text-gray-600 dark:text-gray-300 hover:text-[#007BFF] dark:hover:text-[#007BFF] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blog/assessment-session" className="text-sm text-gray-600 dark:text-gray-300 hover:text-[#007BFF] dark:hover:text-[#007BFF] transition-colors">
                  How we plan assessment session?
                </Link>
              </li>
              <li>
                <Link href="/blog/student-life" className="text-sm text-gray-600 dark:text-gray-300 hover:text-[#007BFF] dark:hover:text-[#007BFF] transition-colors">
                  How we manage student life?
                </Link>
              </li>
              <li>
                <Link href="/blog/effective-student" className="text-sm text-gray-600 dark:text-gray-300 hover:text-[#007BFF] dark:hover:text-[#007BFF] transition-colors">
